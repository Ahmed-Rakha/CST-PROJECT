    ...
    try {
      ...
      <div class="bg-dark single-added-item-details d-flex align-items-center  flex-column gx-0 gap-3 p-3 mb-3 border border-3 rounded-1" id="_${filteredProducts[i].id}">
        ...
        <div class="added-item-pricing m-0 p-3 rounded-1 text-center col-lg-8 row g-0">
          <div class="count-of-items m-0 p-0 col-md-3 d-flex align-items-center justify-content-center border border-0 bg-light text-dark">
            <p class="m-0 p-0"><span class="text-dark fw-bold ps-2">1</span> <span class="iconamoon--arrow-down-2-bold"></span></p>
            <ul class="display-none-toggle m-0 p-0"></ul>
          </div>
